...
To be honest on this, i have spent quite a lot of time on these platforms. Back in 2019 most of my friends convienced me to take the `OSCP` exam but guess what i was too scared to take the stand i think it was the right decision. There is no need to rush in life. What's meant to happen will surely happen and one shouldn't rush into making some decisions.....<br>
...
The Secret is, i used [Proving Grounds](https://www.offensive-security.com/labs/ "Proving Grounds") as a `test exam` luckily for me most of my friends were preparing for their `OSCP` exams. Two friends took their exam before me `1 failed the exam while the other passed`. I was scared because i am next in line. What my friends and i usually is, we will select 5 machines from `PG Practice` The machines were `(2 20points, 2 25points & 1 10pointer)`, Hack these machines in 24hrs without help, make a report then compare our reports. Why did we do this?<br>

> 1 To build up report writing skills.<br>
> 2 To learn each other’s methods of attacking targets.
