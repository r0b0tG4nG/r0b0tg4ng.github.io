...
tags: [EchoCTF, exploit-db, OSCP, OSWA, Hack the box, PwnTillDawn ]
math: true
mermaid: true
image:
...
3. Are you prepared mentally for OSEP??

With these questions in mind, I decided it's best to switch to a different a course while preparing myself for PEN-300. On August 12 2022, I started with `WEB-200` course materials. As usual you know my style of doing things... I jumped straight into pwning the labs without reading course materials. This method works best for me... Why? from this is will be able to test out what I know against what I am about to study. Few days into the lab, I got stuck on exploiting `XSS` vulnerability my first box. `Oops thought I know it all got to jump back to the course material`🤪.  
...
Alright let me add my voice to this discussion.... I will start with `PortSwigger labs`, this is without any doubt that PortSwigger labs contains rich resources and it's rated `Number 1` on almost every blog that I have read but this doesn't mean that you will do `100% fine` without `OffSec Labs`. I can assure you that topics that I thought I know very well and didn’t need any more information about them, in the OffSec course material, I’ve learnt a lot more than that I can imagine. 

`OffSec` did a great job in breaking down the explanations of all vulnerabilities and also provide exercise for all instances that's mentioned in the course content. My best advice is: `"These platforms offer an opportunity to learn. As far as you are learning something new and beneficial from these platforms/materials, I don’t think there is a need to argue which one is the best"` I have learnt a lot from these platforms and I will advise you to do same for your own good 🤗 Remember you are studying for yourself and not the community😜.
...
The funny part was I got a little bit bored after completing the course materials and also `PortSwigger labs` so I decided to start playing with web applications from <a href="https://hacktheforce.net/">HackTheForce</a> anytime I got stuck exploiting a vulnerability I will go knocking the doors of my good friend <a href="https://twitter.com/kleiton0x7e">Kleiton Kurti</a> **( a little secret "he's a monster when it comes to webapps" 😜)**...... On one of the instances from <a href="https://hacktheforce.net/">HackTheForce</a>, I got an `unintended remote access to the database that served all instances`....... I scheduled my `OSWA Exam` on `December 3rd 2022` at `22:00 GMT` as usual of me a `night owl`🦉.

![image](https://user-images.githubusercontent.com/67085453/206223453-0f8dad86-310f-467c-a04d-d83734092fa4.png)

Still not satisfied with <a href="https://hacktheforce.net/">HackTheForce</a> instances, I decided to participate in **PwnTillDawn Middle East & Africa CTF Competition** which took place from `November 30 2022` to `December 2nd 2022`... Remember my exam is scheduled on the `December 3rd 2022`. Luckily for me, I managed to win the competition🎉🎊🥳. 
...
On `December 3rd, 2022`, I woke up at 9am (stress from the CTF), time to rest right? unfortunately, we are renovating our home which I ended up holding a paint brush painting a room🤣. Not feeling tensed or pressured, but rather relaxed... Family and friends that were around kept asking `"Aren't you supposed to sleep before your exam tonight? are you not supposed to read before the exam??`. Well, here is my little secret: on days of execution, I try as much as possible to stay away from computers else I will end up trying to compromise vulnerable web instances. At `2:00 pm GMT` I took a short nap till `2:45 pm GMT` then jumped back to painting work...
...
`9hrs` into the exam, I managed to acquire `50 points` **(3 local.txt & 2 proof.txt)** all I need now is an `extra 20 points` to pass the exam. Everything was moving smoothly and I was happy about it, I even thought i will finish the exam in the next `3/4hrs` little did I know that there was a **HUGE roadblock ahead**. On the quest for `extra 20points`, I got stuck for `7hrs` on the remaining targets. Almost lost hope in compromising these targets because I tried everything, I know but none worked. I knew I was missing a piece of information from the experience I had with the `OSWA lab machines` anytime you get stuck for a while there are two things involve.
1. You are missing a piece of the puzzle 
2. You are trying to exploit a wrong vulnerability (Vulnerability may exists on the target but that's not the right vulnerability to exploit)
...
Remember always that **"In any given moment you have two choices: Step forward into growth or step back into safety"** and also keep in mind that **"The hardest person you'll ever say goodbye to is the person you used to be"** Step out of that comfort zone you won’t grow dare to dream. `When you dream it, believe it and you will achieve it.`

**> Special Thanks**
> The Lord Our God for HIS Countless Blessings. 🙏<br>

> My mentors especially <a href="https://twitter.com/pantelisroditis">DataBus</a> & <a href="https://twitter.com/wotwot563/"> W0tw0t</a> <br>

> My good friend <a href="https://twitter.com/kleiton0x7e">Kleiton Kurti</a> AKA Web-Monster
