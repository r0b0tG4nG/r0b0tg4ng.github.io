...
Alright let me add my voice to this discussion.... I will start with `PortSwigger labs`, It is without any doubt that PortSwigger labs contain rich resources and it's rated `Number 1` on almost every blog that I have read but this doesn't mean that you will do `100% fine` without `OffSec Labs`. In the `Web-200` course content, I've learned a lot more than I could imagine about subjects that I previously believed I knew very well and didn't need any additional information about. 
