...
Alright let me add my voice to this discussion.... I will start with `PortSwigger labs`, this is without any doubt that PortSwigger labs contain contains rich resources and it's rated `Number 1` on almost every blog that I have read but this doesn't mean that you will do `100% fine` without `OffSec Labs`. In the OffSec course content, I've learned a lot more than I could imagine about subjects that I previously believed I knew very well and didn't need any additional information about. 
...
Never assume that a vulnerability won't be included to an exam lab. Otherwise, you risk ending up stranded like I did since an exam's most unexpected vulnerability turned out to be present. I nearly failed my exam because I was of the mindset that **"There was no way it will show up."** Every vulnerability covered in the `OSWA course` is likely to implemented on any exam machine... My advice is: **"Stay concentrated, learn everything, understand everything, and be ready for everything."** 
...
Remember always that **"In any given moment you have two choices: Step forward into growth or step back into safety"** and also keep in mind that **"The hardest person you'll ever say goodbye to is the person you used to be"** Step out of that comfort zone else you won’t grow. Always dare to dream. `When you dream it and believe it, you will surrely achieve it.`
